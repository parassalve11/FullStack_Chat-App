...
export const user_service = "http://13.233.255.160:5000/api/v1"
export const chat_service = "http://13.233.255.160:5002/api/v1";
export const chat_service2 = "http://13.233.255.160:5002/"
