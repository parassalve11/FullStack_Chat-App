...
export const user_service = `http://${process.env.NEXT_PUBLIC_USER_SERVICE}/api/v1`
export const chat_service = `http://${process.env.NEXT_PUBLIC_CHAT_SERVICE}/api/v1`
export const chat_service2 = `http://${process.env.NEXT_PUBLIC_CHAT_SERVICE}`
